...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'solarium.client_registry' => 'getSolarium_ClientRegistryService',
            'solrservice' => 'getSolrserviceService',
    ...
    {
        require_once (__DIR__.'/jms_diextra/doctrine/EntityManager_54caa7ad81894.php');
        ...
        $b = \Doctrine\ORM\EntityManager::create($this->get('doctrine.dbal.default_connection'), $a);
        $this->get('doctrine.orm.default_manager_configurator')->configure($b);
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager54caa7ad81894_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($b, $this);
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_89e0df45609af899ebf526f4caa8e47c01d05ec414b2d0241353ed4883fba90c');
        return $instance;
    }
    ...
    {
        return $this->services['solarium.client.default'] = new \Solarium\Client(array('endpoint' => array(0 => $this->get('solarium.client.endpoint.default'))));
    }
    protected function getSolarium_Client_Endpoint_DefaultService()
    {
        return $this->services['solarium.client.endpoint.default'] = new \Solarium\Core\Client\Endpoint(array('timeout' => 5, 'host' => '92.222.40.151', 'port' => 8983, 'path' => '/solr/collection1', 'key' => 'default'));
    }
    protected function getSolarium_ClientRegistryService()
    {
        return $this->services['solarium.client_registry'] = new \Nelmio\SolariumBundle\ClientRegistry(array('default' => $this->get('solarium.client.default')), 'default');
    }
    protected function getSolrserviceService()
    {
        return $this->services['solrservice'] = new \SolrServiceBundle\Controller\DefaultController($this->get('solarium.client.default'));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/nelmio/solarium-bundle/Resources/views'), 'NelmioSolarium');
        $instance->addPath(($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/views'), 'Doctrine');
        $instance->addPath(($this->targetDirs[3].'/src/WebsiteBundle/Resources/views'), 'Website');
        $instance->addPath(($this->targetDirs[3].'/src/SolrServiceBundle/Resources/views'), 'SolrService');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('54caa7ad57884')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SolrServiceBundle' => 'SolrServiceBundle\\SolrServiceBundle',
            ),
            ...
            'solarium.client_registry.class' => 'Nelmio\\SolariumBundle\\ClientRegistry',
            ...
            'jms_di_extra.doctrine_integration.entity_manager.file' => (__DIR__.'/jms_diextra/doctrine/EntityManager_54caa7ad81894.php'),
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager54caa7ad81894_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
